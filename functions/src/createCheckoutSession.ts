...
const TICKET_PRICE_CENTS = 2_500;
const MIN_DONATION_CENTS = 100; // $1
const MAX_DONATION_CENTS = 100_000_00; // $100,000 safety ceiling
...
export const createCheckoutSession = onRequest(
  ...
  async (req, res) => {
    ...
    const body = (req.body ?? {}) as { type?: unknown; amountCents?: unknown; campaignId?: unknown };
    ...
    const campaignId =
      typeof body.campaignId === 'string' && /^[a-zA-Z0-9_-]{1,64}$/.test(body.campaignId)
        ? body.campaignId
        : null;
