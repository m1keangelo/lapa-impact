...
export const es: Dictionary = {
  ...
  home: {
    ...
    campaigns: {
      ...
      title: 'Maneras de ayudar ahora mismo.',
      body: 'Personas con nombre, necesidades concretas. Tu donativo entra a un solo fondo que atiende estas necesidades en orden de urgencia — y ves cada salida en el registro en vivo.',
      of: 'de',
      goal: 'meta',
      giveCta: 'Ayudar aquí',
  ...
  admin: {
    ...
    campaignForm: {
      title: 'Necesidades (mini-campañas)',
      sub: 'Personas con nombre, metas concretas. Aparecen en la página principal con su barra de progreso. El dinero entra al fondo único — tú actualizas "recaudado" cuando se asigne.',
      newTitle: 'Nueva necesidad',
      titleEn: 'Título (inglés)',
      titleEs: 'Título (español)',
      storyEn: 'Historia corta (inglés)',
      storyEs: 'Historia corta (español)',
      goal: 'Meta (USD)',
      imageUrl: 'URL de la foto (https o /ruta-local)',
      imageHint: 'Sube la foto primero en la pestaña Fotos y pega aquí su enlace.',
      createCta: 'Publicar necesidad',
      listTitle: 'Necesidades activas',
      raisedNow: 'Recaudado hasta ahora (USD)',
      updateCta: 'Actualizar',
      markDone: 'Marcar como lograda',
      empty: 'Todavía no hay necesidades — crea la primera arriba.',
      saved: 'Guardado.',
    },
    heroForm: {
