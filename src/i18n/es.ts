...
export const es: Dictionary = {
  ...
  feed: {
    ...
    sub: 'Cada donativo, cada mercado, cada kit de higiene que llega al albergue — a la vista de todos. Los donantes aparecen solo con su nombre y su inicial.',
