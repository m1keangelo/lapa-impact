/**
 * DonateLadder — the single donation decision, reusable.
 *
 * Lives on the one-page homepage (id="donar") AND on the standalone
 * /donate route (kept for shared links / Stripe return URLs). One source
 * of truth: the amount ladder with the $25 solidarity ticket visually
 * prominent, custom amount, Give Now.
 *
